...
class BinaryFocalLoss(torch.nn.Module):
    ...
    def forward(self, inputs, targets):
        ...
        loss = -self.alpha * (1 - pt).pow(self.gamma) * logpt
...
class PRE_Processor(Processor):
    ...
    def load_model(self):
        ...
        self.loss = BinaryFocalLoss(alpha=0.2, gamma=2.0)
    ...
    def get_parser(add_help=False):
        ...
        parser = argparse.ArgumentParser(
            ...
            description='SAFA-GCN')

        # region arguments yapf: disable
        # evaluation
        parser.add_argument('--show_acc', type=int, default=[1], nargs='+', help='in case of per infant each video')
        # optim
